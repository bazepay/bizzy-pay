...
export function PhoneFrame({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[oklch(0.94_0.02_280)] md:py-8">
      <div className="relative w-full md:w-[420px] md:h-[860px] md:rounded-[3rem] md:border-[10px] md:border-black md:shadow-[0_30px_80px_-20px_rgba(20,10,60,0.5)] overflow-hidden bg-background min-h-screen md:min-h-0 md:[transform:translateZ(0)]">
        {/* notch (desktop only) */}
